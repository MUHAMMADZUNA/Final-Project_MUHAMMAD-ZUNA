...
Papa.parse("sales.csv", {
    ...
    complete: function (results) {
        ...
        window.askAI = function () {
            ...
            const q = questionEl.value.toLowerCase().trim();
...
function updateDashboard(data) {
    ...
    setHTML("riskLevel",    margin > 20 ? "Low" : margin > 10 ? "Medium" : "High");
